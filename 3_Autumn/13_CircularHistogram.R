...
# Save the plot
ggsave("AutumnDay_CircularHistogram.png", width = 12, height = 17, dpi = 300)


# ------------------------------------------------------------------------------
# 
#                    Autumn Nighttime Migrations
#
# ------------------------------------------------------------------------------
...
# Save the plot
ggsave("AutumnNight_CircularHistogram.png", width = 12, height = 18, dpi = 300)
