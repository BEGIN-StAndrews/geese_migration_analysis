...
filtered_data <- read.csv("Autumn_Newinterval.csv")
...
write.csv(data_cleaned, "Autumn_FinalProcessed.csv", row.names = FALSE)
...
df_filtered <- read.csv("Autumn_FinalProcessed.csv")
