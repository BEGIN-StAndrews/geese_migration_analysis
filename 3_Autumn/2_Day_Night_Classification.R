...
# 
# Input:
#   - Annotated GPS tracking data: 'Autumn_FinalProcessed.csv'.
# 
# Output:
#   - Updated dataset with day/night classification: 'Autumn_DayNight.csv'.
# 
# Data Source:
...
migration_data <- read.csv("Autumn_FinalProcessed.csv")
...
write.csv(migration_data, "Autumn_DayNight.csv", row.names = FALSE)
