...
# 
# Input:
#   - Dataset with wind parameters: 'Autumn_WindParameters.csv'.
# 
# Output:
#   - Updated dataset with magnetic heading and apparent inclination: 'Autumn_Magnetic.csv'.
...
df <- read.csv("Autumn_WindParameters.csv")
...
write.csv(df,"Autumn_Magnetic.csv", row.names = FALSE)
