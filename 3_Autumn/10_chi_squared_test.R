...
#       * Saved to 'Autumn_Proportion_Results.csv'
...
periods <- list(
  AutumnDay = list(file = "AutumnDay_Clustered.csv", cluster_col = "cluster_id", id_col = "individual.local.identifier"),
  AutumnNight = list(file = "AutumnNight_Clustered.csv", cluster_col = "cluster_id", id_col = "individual.local.identifier")
)
...
write.csv(final_proportion_results, "Autumn_Proportion_Results.csv", row.names = FALSE)
