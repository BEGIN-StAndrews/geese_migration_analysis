...
# 
# Input:
#   - Processed dataset with interpolated wind data: 'Autumn_DayNight.csv'.
# 
# Output:
#   - Updated dataset with wind-related parameters: 'Autumn_WindParameters.csv'.
...
data <- read.csv("Autumn_DayNight.csv")
...
write.csv(data, "Autumn_WindParameters.csv", row.names = FALSE)
