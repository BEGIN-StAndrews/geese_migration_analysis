...
# 
# Input:
#   - Dataset with angular deviations and other features: 'Spring_Deviation.csv'.
# 
# Output:
#   - Processed day clustering features: 'Spring_Day_CF.csv'.
#   - Processed night clustering features: 'Spring_Night_CF.csv'.

# Note:
# The files "Spring_Day_CF.csv" and "Spring_Night_CF.csv" generated in this script
...
write.csv(day_filtered, "Spring_Day_CF.csv", row.names = FALSE) 
write.csv(night_filtered, "Spring_Night_CF.csv", row.names = FALSE) 
